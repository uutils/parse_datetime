...
/// assert_eq!(time.unwrap(), "2023-06-03 12:00:01".parse::<DateTime>().unwrap().to_zoned(TimeZone::UTC).unwrap());
/// ```
///
///
/// # Returns
...
//             assert_eq!(actual.unwrap().timestamp().as_second(), TEST_TIME);
//         }
...
//             let expected = "1987-05-07 00:00:00"
//                 .parse::<DateTime>()
//                 .unwrap()
//                 .to_zoned(TimeZone::system())
//                 .unwrap();

//             assert_eq!(Ok(expected.clone()), parse_datetime("1987-05-07"));
//             assert_eq!(Ok(expected.clone()), parse_datetime("1987-5-07"));
//             assert_eq!(Ok(expected.clone()), parse_datetime("1987-05-7"));
//             assert_eq!(Ok(expected.clone()), parse_datetime("1987-5-7"));
//             assert_eq!(Ok(expected.clone()), parse_datetime("5/7/1987"));
//             assert_eq!(Ok(expected.clone()), parse_datetime("5/07/1987"));
//             assert_eq!(Ok(expected.clone()), parse_datetime("05/7/1987"));
...
//                 assert_eq!(
//                     expected,
//                     format!("{}", actual.strftime("%Y%m%d%H%M%z").to_string())
//                 );
//             }
//         }
